   ...
   if(SM_GetRecentStructuralEvent(LAYER_CTF, 3, ctfEvent))
     {
      ...
      if(evBar >= 0 && MathAbs(evBar - barIndex) <= 3)
        {
         g_fvgList[idx].causalTag = ctfEvent.tag;
   ...
   if(SM_GetRecentStructuralEvent(LAYER_CTF, 3, ctfEvent))
     {
      ...
      if(evBar >= 0 && MathAbs(evBar - barIndex) <= 3)
        {
         g_viList[idx].causalTag = ctfEvent.tag;
         g_viList[idx].bornDirection =
            (type == VI_BULLISH) ? DIR_BULLISH : DIR_BEARISH;
   ...
   if(SM_GetRecentStructuralEvent(LAYER_CTF, 3, ctfEvent))
     {
      ...
      if(evBar >= 0 && MathAbs(evBar - barIndex) <= 3)
        {
         g_voidList[idx].causalTag = ctfEvent.tag;
         g_voidList[idx].bornDirection =
            (type == VOID_BULLISH) ? DIR_BULLISH : DIR_BEARISH;
